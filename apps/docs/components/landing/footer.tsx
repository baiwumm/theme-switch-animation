...
const RELATED_LINKS = [
  ...
  { label: '@nuxtjs/color-mode', href: 'https://github.com/nuxt-modules/color-mode' },
  { label: 'View Transitions API 规范', href: 'https://drafts.csswg.org/css-view-transitions-1/' },
  { label: 'magicui（形状观感参考）', href: 'https://magicui.design/docs/components/animated-theme-toggler' },
] as const
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-5xl gap-10 sm:grid-cols-3">
          <div>
            <div className="mb-3 flex items-center gap-2.5">
              ...
              <img src="/logo-light.svg" alt="" className="size-7 rounded-lg dark:hidden" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/logo-dark.svg" alt="" className="hidden size-7 rounded-lg dark:block" />
        ...
        <div className="mx-auto mt-12 flex max-w-5xl flex-col items-center justify-between gap-3 border-t border-dashed border-black/10 pt-6 text-xs text-muted-foreground sm:flex-row dark:border-white/10">
          ...
          <span className="flex items-center gap-4">
            <Link href={AUTHOR_URL} target="_blank" rel="noreferrer" className="transition-colors hover:text-foreground">
              baiwumm.com
            </Link>
